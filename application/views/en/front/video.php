...
<head>
    ...
    <title>Capital country Home - Video</title>
    <!--[if lt IE 9]>
...
<div class="main clearfloat mt20">
    <div class="video_box clearfloat">
        <div class="video fl mr20" >
            <h2>ASPIRE Testimoninal</h2>
            <h4>Chiara Ftancica Malta</h4>
            <video width="420" height="240" controls >
                <source src="/assets/video/video001.mp4" type="video/mp4" >
                您的浏览器不支持Video标签。
            </video>
            <p>视频简短介绍：关于资本国度的一些简单介绍，让您充分了解我们公司的一些基本情况，给予您最基本的信任...</p>
        </div>
        <div class="video fr" >
            <h2>ASPIRE Testimoninal</h2>
            <h4>Chiara Ftancica Malta</h4>
    ...
    <div class="tc mt10 mb10"><img src="/assets/pic/split-line.png"></div>
    <div class="video_box clearfloat">
        <div class="video fl mr20" >
            <h2>ASPIRE Testimoninal</h2>
            <h4>Chiara Ftancica Malta</h4>
    ...
    <div class="tc mt10 mb10"><img src="/assets/pic/split-line.png"></div>
    <a href="#" class="more_video">More</a>
</div>
